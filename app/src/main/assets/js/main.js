...
function ChangeKeyboarLayoutStatus() {
    ...
    if (KeyBoardLayout == 1 || EnglishKeyboard == true) { // keyboard_ley.innerHTML = "বর্তমান লেখন পদ্ধতি: <b>ইংরেজী</b>";
        field[0].checked = true;
    } else if (KeyBoardLayout == 2) { // keyboard_ley.innerHTML = "বর্তমান লেখন পদ্ধতি: <b>বিজয় বাংলা</b>";
        field[KeyBoardLayout - 1].checked = true;
    } else if (KeyBoardLayout == 3) { // keyboard_ley.innerHTML = "বর্তমান লেখন পদ্ধতি: <b>সামহোয়্যার-ইন ফোনেটিক বাংলা</b>";
        field[KeyBoardLayout - 1].checked = true;
    } else if (KeyBoardLayout == 4) { // keyboard_ley.innerHTML = "বর্তমান লেখন পদ্ধতি: <b>অভ্র ফোনেটিক বাংলা</b>";
        field[KeyBoardLayout - 1].checked = true;
    } else if (KeyBoardLayout == 5) { // keyboard_ley.innerHTML = "বর্তমান লেখন পদ্ধতি: <b>ইউনিজয় বাংলা</b>";
        field[KeyBoardLayout - 1].checked = true;
    }
}
...
let fontText = document.querySelector("#font__value");
